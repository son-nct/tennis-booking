<template>
    <div>
        <div class="flex items-center justify-between">
            ...
            <router-link class="text-base mr-8 text-gray-500 hover:text-gray-700 duration-200 cursor-pointer" to="/">Xem
                Tất Cả</router-link>
        </div>
        <!--btn control slide-->
            ...
            <div class="w-full h-auto min-h-96 flex items-center justify-between">
                <div class="relative w-full h-[500px] my-4">
                    <div :class="frameName"
                        ...
                        <high-rating-court class="aspect-square duration-200" v-for="vendor in 6" :key="vendor" />
                    </div>
                </div>
            </div>
        </div>
...
const HighRatingCourt = defineAsyncComponent(() => import('./HighRatingCourt.vue'))
