          ...
          <div class="mt-4 mx-4 w-full">
            <form class="flex items-center">
              ...
              <div class="relative w-full">
                <div
                  class="absolute inset-y-0 left-0 flex items-center cursor-pointer pl-3 pointer-events-none"
                >
                  <svg
                    aria-hidden="true"
                ...
                <input
                  type="text"
                  id="voice-search"
                  class="w-[450px] bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block pl-10 p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
          ...
          <div class="mr-5 flex float-right relative">
            ...
            <transition name="fade">
              ...
              >
                ...
                <ul
                  v-for="notify in notify_list"
                  :key="notify.id"
                  @click="showApproveDetail(1)"
              ...
              >
                ...
                <div class="py-1">
                  <span
                    ...
                    class="block py-2 px-4 text-sm text-gray-700 dark:text-gray-200 hover:bg-blue-500 hover:text-white cursor-pointer"
                    >Đăng xuất</span
                  >
                </div>
              </div>
